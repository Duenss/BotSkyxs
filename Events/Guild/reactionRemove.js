...
module.exports = {
  ...
  async execute(reaction, user, client) {
    ...
    const detalles =
      `Se ha removido una reacción de un mensaje.\n\n` +
      `**📄 Detalles:**\n` +
    ...
    const container = new ContainerBuilder()
      ...
      .addTextDisplayComponents(
        new TextDisplayBuilder().setContent("## 😀 Reacción Removida"),
      )
    ...
    await logChannel
      ...
      .then(() => console.log(`[LOG ACTIVIDAD REACCION] ✅ Reacción removida registrada en ${logChannel.name}`))
